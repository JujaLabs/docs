...
### GMF-F14
***GMF-F14 Я как пользователь хочу иметь возможность поприветствовать нового участника.***

* GMF-F14-D1 Приветствие отправляется определенному новому пользователю только один раз. Если это правило нарушается, пользователь должен получить сообщение об ошибке в формате GMF-D5-2 с текстом “Этот пользователь уже поприветствован”.
* GMF-F14-D2 Выдается 1 джуджик
* GMF-F14-D3 Текст (description) приветственного сообщения "Welcome to JuJa!"
...
```
    [ “...” ] - один элемент в массиве (id сохраненной ачивки)
```
* GMF-F14-S1-REQ ``/welcome @slack_nick_name``
* GMF-F14-S2-RSP Новый участник поприветствован!
* GMF-F14-S3-RSP Текст ошибки. Формат команды “текст из GMF-F14-S1-REQ”. В тексте сообщения должен быть указан ник кому выдается приветствие

### GMF-F15

**GMF-F15 Я как пользователь хочу иметь возможность сделать interview report с целью делиться опытом прохождения собеседований.**

* GMF-F15-D1 Нет необходимости указывать кому - интервью рипорт я могу отправить только сам себе
* GMF-F15-D2 За каждый интервью рипорт я получаю по 10 джуджиков
* GMF-F15-D3 Допускается отправка нескольких интервью рипортов в день. 
...
* GMF-F15-S1-REQ ``/interview My interview report message. I got an offer! ``
* GMF-F15-S2-RSP Спасибо ваш отчет принят
* GMF-F15-S3-RSP Текст ошибки. Формат команды “текст из GMF-F15-S1-REQ”
