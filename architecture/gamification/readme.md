...
### GMF-F11
***GMF-F11 Я как пользователь хочу иметь возможность поприветствовать нового участника.***

* GMF-F11-D1 Приветствие отправляется новому пользователю только один раз. 
* GMF-F11-D2 Выдается 1 джуджик
* GMF-F11-D3 Текст (description) приветственного сообщения "Welcome to JuJa!"
...
**GMF-F12 Я как пользователь хочу иметь возможность сделать interview report с целью делиться опытом прохождения собеседований.**

* GMF-F12-D1 Нет необходимости указывать кому - интервью рипорт я могу отправить только сам себе
* GMF-F12-D2 За каждый интервью рипорт я получаю по 10 джуджиков
* GMF-F12-D3 Допускается отправка нескольких интервью рипортов в день. 
